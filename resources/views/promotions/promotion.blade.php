        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <h4> Promotion in advertise section!</h4>

                        @foreach($advertise_section as $promotionpages)

                        <ul>
                            @if($promotionpages->type)
                            <li><a href="{{  url('leads/form/'.$promotionpages->type) }}">{{$promotionpages->type}}</a></li>

                            @endif
                        </ul>
                        @endforeach

                        <h4> Promotion in magazine subscribe</h4>
