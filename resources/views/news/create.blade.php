...
<script>
    ...
    <div class="row">
        <div class="col-md-offset-3 col-md-6">
                {!! Form::open(array('route' => 'newsone.store','files'=>true)) !!} 
                ...
                <div class="form-group">
                    ...
                    {{ Form::input('text', 'news_img_alt', null, ['class' => 'form-control']) }}
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    {{ Form::textarea('description', null, ['id' => 'editor1', 'class' => 'form-control', 'size' => '30x4']) }}
                </div>
