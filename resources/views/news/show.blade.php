...
@section('content')
    <div class="well well-sm">
        <div class="row">
            <div class="col-md-6">
                <a class="btn btn-sm btn-default" href="{{ route('newsone.index') }}"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</a>
            </div>

            <div class="col-md-6">
                 <a class="btn btn-sm btn-warning pull-right" href="{{ route('newsone.edit', $news->id) }}"><i class="fa fa-pencil-square" aria-hidden="true"></i> Edit</a>
            </div>
        </div>
    </div>
      <div class="well well-sm">
            ...
            <div class="row">  
              ...
              <div class="col-md-9">
                <h5>
                  @if($news->news_image)
                  <img width="200" src="<?php echo config('app.url'); ?>/news/<?php echo $news->news_image;?>">
                  @endif
                </h5>
              </div>
             </div>
