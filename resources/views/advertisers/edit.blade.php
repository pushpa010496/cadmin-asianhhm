...
@section('header')
    <div class="page-header">
        <h3><i class="fa fa-plus-square-o" aria-hidden="true"></i> Advertiser / Edit </h3>
    </div>
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-offset-3 col-md-6">
                {!! Form::model($advertiser,array('route' =>[ 'advertisers.update',$advertiser->id],'method'=> 'PUT', 'files'=>true)) !!}                
