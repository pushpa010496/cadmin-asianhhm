...
@section('header')
    ...
    <div class="page-header">
        ...
        <h3><i class="fa fa-plus-square-o" aria-hidden="true"></i> Projects / Edit </h3>
...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-offset-3 col-md-6">
                ...
                {!! Form::model($project,array('route' => ['project.update',$project->id],'method'=>'PUT','files'=>true)) !!}                
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    ...
                    {{ Form::textarea('description', null, [ 'id' => 'editor1','class' => 'form-control my-editor','size'=>'30x4','required'=>'required']) }}
                ...
                <div class="form-group">
                   ...
                   <img src="{{config('app.url').'/knowledgebank/project/'.$project->image}}" height="100px" width="100px">
