...
@section('header')
    ...
    <div class="page-header">
        ...
        <h3><i class="fa fa-plus-square-o" aria-hidden="true"></i> Interviews / Edit </h3>
...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-offset-3 col-md-6">
                ...
                {!! Form::model($interview,array('route' =>

                ['interview.update',$interview->id],'method'=>'PUT','files'=>true)) !!}                
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    ...
                    {{ Form::textarea('quest_answer', null, [ 'id' => 'editor2','class' => 'form-control my-editor','size'=>'30x4']) }}
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                   ...
                   <img src="{{config('app.url').'/knowledgebank/interview/'.$interview->photo}}" height="100px" width="100px">
