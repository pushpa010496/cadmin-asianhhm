...
@section('header')
    ...
    <div class="page-header">
        ...
        <h3><i class="fa fa-plus-square-o" aria-hidden="true"></i> Case Study / Create </h3>
...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-offset-3 col-md-6">
                ...
                {!! Form::open(array('route' => 'casestudies.store','files'=>true, 'enctype' => 'multipart/form-data')) !!}                
                ...
                {{ Form::file('image', ['class' => 'form-control','size'=>'30x4', 'required' => true]) }}
