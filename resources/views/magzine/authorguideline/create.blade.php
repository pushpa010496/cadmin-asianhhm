...
<div class="page-header">
  <h3><i class="fa fa-plus-square-o" aria-hidden="true"></i> Author Guidelines / Create </h3>
</div>
</div>
@endsection
...
<div class="row">
  <div class="col-md-offset-3 col-md-6">
    <div class="row well well-sm">
     {!! Form::open(array('route' => 'authorguideline.store','files'=>true)) !!}
 ...
 <div class="">
  ...
  <div class="col-md-12">
    <div class="form-group mt-20">
      ...
      <a class="btn btn-sm btn-default pull-left" href="{{ route('authorguideline.index') }}"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</a>
    </div>
  </div>
</form>
</div>
