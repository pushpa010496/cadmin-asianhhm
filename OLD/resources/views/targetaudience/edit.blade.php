...
@section('header')
    <div class="page-header">
        <h3><i class="fa fa-plus-square-o" aria-hidden="true"></i> Target Audience / Edit </h3>
    </div>
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-offset-3 col-md-6">
                {!! Form::model($targetaudience,array('route' => ['targetaudience.update',$targetaudience->id],'method'=>'PUT', 'files'=>true)) !!}                
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                  @if($targetaudience->pdf)
                    <a href="{{config('app.url').'/targetaudience/'.$targetaudience->pdf}}" target="_blank">View File</a>
                  @endif
               ...
               <div class="form-group">
                    ...
                    <select name="active_flag" class="form-control" required="required">
                        ...
                        @if($targetaudience->active_flag == 1)
