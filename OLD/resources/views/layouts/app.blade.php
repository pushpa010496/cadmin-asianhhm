             ...
             <div class="container">
                  <nav class="navbar navbar-default" id="mega-nav">
                    ...
                    <ul class="nav navbar-nav">
                     ...
                     <ul class="nav navbar-nav">
                        <li class="dropdown mega-dropdown">
                          <a href="#" class="dropdown-toggle" data-toggle="dropdown">Advertise <i class="fa fa-chevron-down text-primary" aria-hidden="true"></i></a>
                          <ul class="dropdown-menu mega-dropdown-menu row">
                            <li class="col-sm-4">
                              <ul>
                            ...
                            <li class="col-sm-4">
                              <ul>
                                  ...
                                  <li><a href="{{ url('advertisers') }}">Advertise</a></li>
                                <li class="divider"></li>                              
                              </ul>
                            </li>
                          </ul>
