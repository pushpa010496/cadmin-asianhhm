...
@section('content')
    <div class="well well-sm">
        <div class="row">
            <div class="col-md-6">
                <a class="btn btn-sm btn-default" href="{{ route('pressrelease.index') }}"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</a>
            </div>

            <div class="col-md-6">
                 <a class="btn btn-sm btn-warning pull-right" href="{{ route('pressrelease.edit', $pressrelease->id) }}"><i class="fa fa-pencil-square" aria-hidden="true"></i> Edit</a>
            </div>
        </div>
    </div>
      <div class="well well-sm">
            ...
            <div class="row">
              ...
              <div class="col-md-9">
                <h5>{{ date('j F Y', strtotime($pressrelease->date)) }}</h5>
              </div>
            </div>
            <div class="row">  
              <div class="col-md-3"> 
            ...
            <div class="row">  
              <div class="col-md-3"> 
                <h5 class="text-primary"><i class="pressreleases icon"></i>Small Image</h5>
              </div>
              <div class="col-md-9">
                <h5>
             ...
             <div class="row">  
              <div class="col-md-3"> 
                <h5 class="text-primary"><i class="pressreleases icon"></i>Big Image</h5>
              </div>
              <div class="col-md-9">
                <h5>
            ...
            <div class="row">  
              ...
              <div class="col-md-9">
                <h5>{{ $pressrelease->short_description }}</h5>
              </div>
               </div>
            <div class="row">  
              <div class="col-md-3"> 
              ...
              <div class="col-md-9">
                <h5>{!! $pressrelease->description !!}</h5>
              </div>
            </div>
            <div class="row">  
              <div class="col-md-3"> 
