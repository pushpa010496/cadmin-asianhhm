...
@section('content')
    <div class="well well-sm">
      ...
      <div class="well well-sm">
            ...
            <div class="row">  
              <div class="col-md-3"> 
                <h5 class="text-primary"><i class="news icon"></i>Small Image</h5>
              </div>
              <div class="col-md-9">
                <h5>
                  @if($news->news_image)
             ...
             <div class="row">  
              <div class="col-md-3"> 
                <h5 class="text-primary"><i class="news icon"></i>Big Image</h5>
              </div>
              <div class="col-md-9">
                <h5>
                  @if($news->big_image)
                  <img width="200" src="<?php echo config('app.url'); ?>/news/<?php echo $news->big_image;?>">
                  @endif
                </h5>
              </div>
             </div>
