...
<div class="page-header">
  <h3><i class="fa fa-plus-square-o" aria-hidden="true"></i> CMS Pages / Create </h3>
</div>
</div>
@endsection
@section('content')
...
<div class="row">
  ...
  <div class="col-md-12">
    <div class="form-group mt-20">
      ...
      <a class="btn btn-sm btn-default pull-left" href="{{ route('cmspages.index') }}"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</a>
    </div>
  </div>
</form>
</div>
