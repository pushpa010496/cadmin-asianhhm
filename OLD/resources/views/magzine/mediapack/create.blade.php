...
<div class="page-header">
  <h3><i class="fa fa-plus-square-o" aria-hidden="true"></i> Media Pack / Create </h3>
</div>
@endsection
 ...
 <div class="col-md-6">
  ...
  <div class="col-md-12">
    <div class="form-group mt-20">
      ...
      <a class="btn btn-sm btn-default pull-left" href="{{ route('mediapack.index') }}"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</a>
    </div>
  </div>
</form>
</div>
