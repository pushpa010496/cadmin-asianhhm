...
<div class="page-header">
  <h3><i class="fa fa-pencil-square" aria-hidden="true"></i> Mediapack / Edit #{{$mediapack->id}}</h3>
</div>
@endsection
...
<div class="row">
  <div class="col-md-offset-1 col-md-10 col-md-offset-1">
    <div class="row well well-sm">
      {!! Form::model($mediapack, ['url' => URL::to('mediapack/' . $mediapack->id), 'method' => 'put','files'=> true]) !!}
     @csrf 
    ...
    <div class="col-md-6">
      <div class="form-group {{ $errors->first('image', 'has-error')}}">
       ...
       @if($mediapack->image)
        <a href="{{ config('app.url').'mediapack/pdf/'.$mediapack->image}}" target="_blank">view image</a>
      @endif
    </div>  
    ...
    <div class="col-md-6">
      <div class="form-group {{ $errors->first('pdf', 'has-error')}}">
       ...
       @if($mediapack->pdf)
        <a href="{{ config('app.url').'mediapack/pdf/'. $mediapack->pdf}}" target="_blank">view pdf</a>
      @endif
    </div>
