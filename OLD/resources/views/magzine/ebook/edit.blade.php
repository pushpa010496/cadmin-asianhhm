  ...
  <div class="col-md-offset-1 col-md-10 col-md-offset-1">
    ...
    <div class="col-md-6">
      ...
      @if($ebook->ebook_image)
        <a href="{{ config('app.url').'ebooks/'. str_slug($ebook->issue->issue_no).'/'. $ebook->ebook_image}}" target="_blank">view image</a>
      @endif
    </div>
    <div class="col-md-6">
      ...
      @if($ebook->magazine_image)
        <a href="{{ config('app.url').'ebooks/'. str_slug($ebook->issue->issue_no).'/'. $ebook->magazine_image}}"  target="_blank">view image</a>
      @endif
    </div>
    ...
    <div class="col-md-6">
      ...
      @if($ebook->image_md)
      <a href="{{ config('app.url').'ebooks/'. str_slug($ebook->issue->issue_no).'/'. $ebook->image_md}}"  target="_blank">view image</a>
      @endif
    </div>
    ...
    <div class="col-md-6">
      ...
      @if($ebook->image_sm)
      <a href="{{ config('app.url').'ebooks/'. str_slug($ebook->issue->issue_no).'/'. $ebook->image_sm}}"  target="_blank">view image</a>
      @endif
    </div>
