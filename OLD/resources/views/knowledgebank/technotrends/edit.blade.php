...
@section('scripts')
  ...
  <script>
     var options = {
    filebrowserImageBrowseUrl: '<?php echo config("app.url"); ?>knowledgebank/technotrends/?type=Images',
    filebrowserImageUploadUrl: '{{public_path("/knowledgebank/technotrends")}}/?type=Images&_token=',
    filebrowserBrowseUrl: '<?php echo config("app.url"); ?>knowledgebank/technotrends/?type=Files',
    filebrowserUploadUrl: '{{public_path("/knowledgebank/technotrends")}}/?type=Files&_token='
  };
