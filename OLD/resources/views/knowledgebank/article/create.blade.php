...
@section('scripts')
  ...
  <script>
    ...
    filebrowserImageBrowseUrl: '<?php echo config("app.url"); ?>knowledgebank/article/?type=Images',

    filebrowserImageUploadUrl: '{{public_path("knowledgebank/article")}}/?type=Images&_token=',

    filebrowserBrowseUrl: '<?php echo config("app.url"); ?>knowledgebank/article/?type=Files',
