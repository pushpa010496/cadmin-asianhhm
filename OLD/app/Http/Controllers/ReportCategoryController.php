...
class ReportCategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $report_category->url = str_slug($request->url, "-");        
    ...
    public function update(Request $request, ReportCategory $reportCategory)
    {
        ...
        $reportCategory->url = str_slug($request->url, "-");
        ...
        Session::flash('message_icon', 'checkmark');
        Session::flash('message_header', 'Success');
        Session::flash('message', "The event \"<a href='reportcategories/$event->title'>" . $event->title . "</a>\" was Updated.");
