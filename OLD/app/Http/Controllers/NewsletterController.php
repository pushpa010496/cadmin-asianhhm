...
class NewsletterController extends Controller
{
    ...
    public function store(Request $request, User $user)
    {
        ...
        request()->file->move(public_path('e-newsletters'), $imageName);
    ...
    public function update(Request $request, Newsletter $newsletter, User $user,$id)
    {
        request()->validate([
         ...
         $file_path = public_path('e-newsletters')."/".$newsletter->file;
        $image_path = public_path('e-newsletters/images')."/".$newsletter->image;
        ...
        if($request->file('image')){
              ...
              if(\File::exists($image_path.'/'.$newsletter->image)){                 
                    \File::delete($image_path.'/'.$newsletter->image);                         
                }           
            
            request()->image->move(public_path('e-newsletters/images'), $newsletter->image);
            //$newsletter->image = $imageName;    
        }
