...
class ArticleController extends Controller
{
    ...
    /*
        if ($request->file('image')) {
            ...
            $uploadedImage->move(public_path('knowledgebank/article'), $filename);
        ...
        */
        ...
        if($request->file('image')){
            ...
            request()->image->move(public_path('knowledgebank/article'), $imageName);
        ...
        $article->url = Str::slug($request->url);
        ...
        return redirect()->route('article.index')->with(['create_message' => 'Successfully Created', 'alert' => 'success']);
    }
